...
// Hardcoded product data for Tie Dye collection
const allProducts = [
  {
    id: 1,
    name: 'Blue Tie Dye Maxi Dress',
    image: 'https://placehold.co/600x800/dae6f2/000?text=Tie+Dye+1',
    price: 2499,
    size: 'M',
  },
  {
    id: 2,
    name: 'Pink & White Tie Dye Kurta',
    image: 'https://placehold.co/600x800/fbe4ec/000?text=Tie+Dye+2',
    price: 2199,
    size: 'L',
  },
  {
    id: 3,
    name: 'Green Tie Dye Co-ord Set',
    image: 'https://placehold.co/600x800/e3fbe4/000?text=Tie+Dye+3',
    price: 2699,
    size: 'S',
  },
  {
    id: 4,
    name: 'Yellow Tie Dye Tunic',
    image: 'https://placehold.co/600x800/fbf7e4/000?text=Tie+Dye+4',
    price: 1999,
    size: 'XL',
  },
  {
    id: 5,
    name: 'Purple Tie Dye Suit',
    image: 'https://placehold.co/600x800/e4e4fb/000?text=Tie+Dye+5',
    price: 2899,
    size: 'M',
  },
];
...
export default function TieDye() {
  ...
  return (
    <div className="text-gray-800 font-sans min-h-screen bg-[#f7f3ed] relative">
      {/* Home / Tie Dye moved to very top */}
      <div className="w-full">
        <p className="text-sm text-gray-500 text-start w-full px-4 pt-8 sm:px-8">Home / Tie Dye</p>
      </div>
      {/* Header with two "TIE DYE" */}
      <div className="container mx-auto w-full flex flex-col items-center mb-6">
        <div className="flex flex-col items-center w-full">
          <h1 className="text-3xl lg:text-4xl font-light mt-8">TIE DYE</h1>
        </div>
      </div>
