...
// Hardcoded product data for Tunics category
const allProducts = [
  {
    id: 1,
    name: 'Floral Print Tunic',
    image: 'https://placehold.co/600x800/f7f3ed/000?text=Tunics+Product+1',
    price: 1299,
    size: 'M',
  },
  {
    id: 2,
    name: 'Pastel Blue Tunic',
    image: 'https://placehold.co/600x800/f7f3ed/000?text=Tunics+Product+2',
    price: 1499,
    size: 'L',
  },
  {
    id: 3,
    name: 'Embroidered White Tunic',
    image: 'https://placehold.co/600x800/f7f3ed/000?text=Tunics+Product+3',
    price: 1799,
    size: 'S',
  },
  {
    id: 4,
    name: 'Geometric Print Tunic',
    image: 'https://placehold.co/600x800/f7f3ed/000?text=Tunics+Product+4',
    price: 1599,
    size: 'XL',
  },
  {
    id: 5,
    name: 'Classic Black Tunic',
    image: 'https://placehold.co/600x800/f7f3ed/000?text=Tunics+Product+5',
    price: 1399,
    size: 'M',
  },
];
...
export default function Tunics() {
  ...
  return (
    <div className="text-gray-800 font-sans min-h-screen bg-[#f7f3ed] relative">
      ...
      <div className="w-full">
        <p className="text-sm text-gray-500 text-start w-full px-4 pt-8 sm:px-8">Home / Tunics</p>
      </div>
      {/* Header */}
      <div className="container mx-auto w-full flex flex-col items-center mb-6">
        <div className="flex flex-col items-center w-full">
          <h1 className="text-3xl lg:text-4xl font-light mt-8">TUNICS</h1>
        </div>
      </div>
