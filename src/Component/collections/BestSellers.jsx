...
// Hardcoded product data for Bestsellers (can be replaced with API data)
const allProducts = [
  {
    id: 1,
    name: 'Bestseller Black Kurta',
    image: 'https://placehold.co/600x800/e9e7e5/000?text=Bestseller+1',
    price: 2199,
    size: 'M',
  },
  {
    id: 2,
    name: 'Bestseller Printed Co-ord Set',
    image: 'https://placehold.co/600x800/e9e7e5/000?text=Bestseller+2',
    price: 2499,
    size: 'L',
  },
  {
    id: 3,
    name: 'Classic Bestseller Suit',
    image: 'https://placehold.co/600x800/e9e7e5/000?text=Bestseller+3',
    price: 2999,
    size: 'XL',
  },
  {
    id: 4,
    name: 'Luxe Bestseller Tunic',
    image: 'https://placehold.co/600x800/e9e7e5/000?text=Bestseller+4',
    price: 1899,
    size: 'S',
  },
  {
    id: 5,
    name: 'Tie Dye Bestseller Dress',
    image: 'https://placehold.co/600x800/e9e7e5/000?text=Bestseller+5',
    price: 2099,
    size: 'M',
  },
];
...
export default function Bestsellers() {
  ...
  return (
    <div className="text-gray-800 font-sans min-h-screen bg-[#f7f3ed] relative">
      {/* Home / Bestsellers at top */}
      <div className="w-full">
        <p className="text-sm text-gray-500 text-start w-full px-4 pt-8 sm:px-8">Home / Bestsellers</p>
      </div>
      {/* Header */}
      <div className="container mx-auto w-full flex flex-col items-center mb-6">
        <div className="flex flex-col items-center w-full">
          <h1 className="text-3xl lg:text-4xl font-light mt-8">BESTSELLERS</h1>
        </div>
      </div>
