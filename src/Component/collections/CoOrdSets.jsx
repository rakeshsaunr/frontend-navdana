...
// Hardcoded product data for Co-ord Sets
const allProducts = [
  {
    id: 1,
    name: 'Ivory Floral Co-ord Set',
    image: 'https://placehold.co/600x800/e9e7e5/000?text=Co-ord+Set+1',
    price: 2599,
    size: 'S',
  },
  {
    id: 2,
    name: 'Pastel Green Printed Co-ord Set',
    image: 'https://placehold.co/600x800/e9e7e5/000?text=Co-ord+Set+2',
    price: 2799,
    size: 'M',
  },
  {
    id: 3,
    name: 'Blue Abstract Co-ord Set',
    image: 'https://placehold.co/600x800/e9e7e5/000?text=Co-ord+Set+3',
    price: 2999,
    size: 'L',
  },
  {
    id: 4,
    name: 'Peach Summer Co-ord Set',
    image: 'https://placehold.co/600x800/e9e7e5/000?text=Co-ord+Set+4',
    price: 2499,
    size: 'XL',
  },
  {
    id: 5,
    name: 'Black & White Stripe Co-ord Set',
    image: 'https://placehold.co/600x800/e9e7e5/000?text=Co-ord+Set+5',
    price: 2699,
    size: 'M',
  },
];
  ...
  return (
    <div className="text-gray-800 font-sans min-h-screen bg-[#f7f3ed] relative">
      ...
      <div className="w-full">
        <p className="text-sm text-gray-500 text-start w-full px-4 pt-8 sm:px-8">Home / Co-ord Sets</p>
      </div>
      {/* Header */}
      <div className="container mx-auto w-full flex flex-col items-center mb-6">
        <div className="flex flex-col items-center w-full">
          <h1 className="text-3xl lg:text-4xl font-light mt-8">CO-ORD SETS</h1>
        </div>
      </div>
