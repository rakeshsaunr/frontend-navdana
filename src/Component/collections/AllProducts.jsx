...
export default function AllProducts() {
  ...
  // Fetch products dynamically (replace URL with your API endpoint)
  useEffect(() => {
    setLoading(true);
    // Example: fetch from /api/products or any endpoint
    fetch('/api/products')
      .then((res) => {
      ...
      .catch((err) => {
        // fallback: show static demo data if fetch fails
        setAllProducts([
          {
            id: 1,
            name: 'Elegant Kurta Set',
            image: 'https://placehold.co/600x800/e9e7e5/000?text=Product+1',
            price: 1999,
            size: 'M',
          },
          {
            ...
            image: 'https://placehold.co/600x800/e9e7e5/000?text=Product+2',
            price: 2499,
            size: 'L',
          },
          {
            id: 3,
            name: 'Classic Suit',
            image: 'https://placehold.co/600x800/e9e7e5/000?text=Product+3',
            price: 2999,
            size: 'XL',
          },
          {
            id: 4,
            name: 'Luxe Tunic',
            image: 'https://placehold.co/600x800/e9e7e5/000?text=Product+4',
            price: 1899,
            size: 'S',
          },
          {
            id: 5,
            name: 'Tie Dye Dress',
            image: 'https://placehold.co/600x800/e9e7e5/000?text=Product+5',
            price: 2099,
            size: 'M',
          },
        ]);
  ...
  return (
    <div className="text-gray-800 font-sans min-h-screen bg-[#f7f3ed] relative">
      {/* Home / All Products at top */}
      <div className="w-full">
        <p className="text-sm text-gray-500 text-start w-full px-4 pt-8 sm:px-8">Home / All Products</p>
      </div>
      {/* Header */}
      <div className="container mx-auto w-full flex flex-col items-center mb-6">
        <div className="flex flex-col items-center w-full">
          <h1 className="text-3xl lg:text-4xl font-light mt-8">ALL PRODUCTS</h1>
        </div>
      </div>
