...
// Hardcoded product data for Suit Set category
const allProducts = [
  {
    id: 1,
    name: 'Pink Floral Hand Block Printed Suit Set',
    image: 'https://placehold.co/600x800/e9e7e5/000?text=Suit+Image+1',
    price: 2499,
    size: 'S',
  },
  {
    id: 2,
    name: 'Blue Ajrakh Cotton Suit Set',
    image: 'https://placehold.co/600x800/e9e7e5/000?text=Suit+Image+2',
    price: 2299,
    size: 'M',
  },
  {
    id: 3,
    name: 'Yellow Dabu Printed Suit Set',
    image: 'https://placehold.co/600x800/e9e7e5/000?text=Suit+Image+3',
    price: 1999,
    size: 'L',
  },
  {
    id: 4,
    name: 'Green Chanderi Silk Suit Set',
    image: 'https://placehold.co/600x800/e9e7e5/000?text=Suit+Image+4',
    price: 2799,
    size: 'XL',
  },
  {
    id: 5,
    name: 'Ivory Embroidered Suit Set',
    image: 'https://placehold.co/600x800/e9e7e5/000?text=Suit+Image+5',
    price: 2999,
    size: 'M',
  },
];
...
export default function SuitSetCategory() {
  ...
  return (
    <div className="text-gray-800 font-sans min-h-screen bg-[#f7f3ed] relative">
      ...
      <div className="w-full">
        <p className="text-sm text-gray-500 text-start w-full px-4 pt-8 sm:px-8">Home / Suit Sets</p>
      </div>
      {/* Header */}
      <div className="container mx-auto w-full flex flex-col items-center mb-6">
        <div className="flex flex-col items-center w-full">
          <h1 className="text-3xl lg:text-4xl font-light mt-8">SUIT SETS</h1>
        </div>
      </div>
